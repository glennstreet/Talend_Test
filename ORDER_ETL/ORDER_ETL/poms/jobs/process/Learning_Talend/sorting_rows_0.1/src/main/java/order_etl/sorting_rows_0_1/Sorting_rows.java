...
package order_etl.sorting_rows_0_1;
...
/**
 * Job: Sorting_rows Purpose: Sorting entries<br>
 ...
 * @status 
 */
public class Sorting_rows implements TalendJob {
	...
	private final String jobName = "Sorting_rows";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Sorting_rows.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_ORDER_ETL_Sorting_rows = new byte[0];
		static byte[] commonByteArray_ORDER_ETL_Sorting_rows = new byte[0];
		...
		public Integer YearsInComp;

		public Integer getYearsInComp() {
			return this.YearsInComp;
		}
		...
		public void copyDataTo(row2Struct other) {
			...
			other.ID = this.ID;
			other.YearsInComp = this.YearsInComp;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ORDER_ETL_Sorting_rows.length) {
					if (length < 1024
							&& commonByteArray_ORDER_ETL_Sorting_rows.length == 0) {
						commonByteArray_ORDER_ETL_Sorting_rows = new byte[1024];
					} else {
						commonByteArray_ORDER_ETL_Sorting_rows = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ORDER_ETL_Sorting_rows, 0, length);
				strReturn = new String(commonByteArray_ORDER_ETL_Sorting_rows,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ORDER_ETL_Sorting_rows) {
				...
				try {
					...
					this.YearsInComp = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.YearsInComp, dos);
		...
		public String toString() {
			...
			sb.append(",YearsInComp=" + String.valueOf(YearsInComp));
			sb.append(",Name=" + Name);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class row1StructILightSerializable extends row1Struct
					...
					public int compareTo(row1StructILightSerializable other) {
						...
						if (this.Sales == null && other.Sales != null) {
							return 1;

						} else if (this.Sales != null && other.Sales == null) {
							return -1;

						} else if (this.Sales != null && other.Sales != null) {
							if (!this.Sales.equals(other.Sales)) {
								return other.Sales.compareTo(this.Sales);
							}
						}
					...
					public org.talend.designer.components.tsort.io.beans.ILightSerializable createInstance(
						...
						try {
							...
							length = dis.readByte();
							if (length == -1) {
								result.YearsInComp = null;
							} else {
								result.YearsInComp = dis.readInt();
							}
							...
							if (length == -1) {
								...
								dis.read(bytes);
								result.Name = new String(bytes, utf8Charset);
							}
					...
					public byte[] toByteArray() {
						...
						try {
							...
							if (this.YearsInComp == null) {
								dos.writeByte(-1);
							} else {
								dos.writeByte(0);
								dos.writeInt(this.YearsInComp);
							}

							if (this.Name == null) {
								dos.writeInt(-1);
							} else {
								byte[] byteArray = this.Name
				...
				iterator_tSortRow_1_SortOut.workDirectory = "/Users/gstreet/RUP/temp"
						+ "/"
						+ jobName
				...
				class tRowGenerator_1Randomizer {
					...
					public Integer getRandomYearsInComp() {
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					...
					row1.YearsInComp = randtRowGenerator_1
							.getRandomYearsInComp();
					row1.Name = randtRowGenerator_1.getRandomName();
					row1.Sales = randtRowGenerator_1.getRandomSales();
					...
					current_tSortRow_1_SortOut.ID = row1.ID;
					current_tSortRow_1_SortOut.YearsInComp = row1.YearsInComp;
					current_tSortRow_1_SortOut.Name = row1.Name;
					current_tSortRow_1_SortOut.Sales = row1.Sales;
				...
				util_tLogRow_1.addRow(new String[] { "ID", "YearsInComp",
						"Name", "Sales", });
				...
				while (iterator_tSortRow_1_SortIn.hasNext()) {
					...
					row2.YearsInComp = current_tSortRow_1_SortIn.YearsInComp;
					row2.Name = current_tSortRow_1_SortIn.Name;
					row2.Sales = current_tSortRow_1_SortIn.Sales;
					...
					if (row2.YearsInComp != null) { //
						row_tLogRow_1[1] = String.valueOf(row2.YearsInComp);

					} //

					if (row2.Name != null) { //
						row_tLogRow_1[2] = String.valueOf(row2.Name);

					} //

					if (row2.Sales != null) { //
						row_tLogRow_1[3] = String.valueOf(row2.Sales);
	...
	public static void main(String[] args) {
		final Sorting_rows Sorting_rowsClass = new Sorting_rows();

		int exitCode = Sorting_rowsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Sorting_rows.class.getClassLoader()
					.getResourceAsStream(
							"order_etl/sorting_rows_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = Sorting_rows.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Sorting_rows");
		}
...
/************************************************************************************************
 * 105032 characters generated by Talend Open Studio for Data Integration on the
 * September 27, 2019 3:05:30 PM EDT
 ************************************************************************************************/
