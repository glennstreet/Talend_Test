...
package order_etl.filtering_rows_0_1;
...
public class Filtering_rows implements TalendJob {
	...
	private final String jobName = "Filtering_rows";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Filtering_rows.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Filtering_rows.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_ORDER_ETL_Filtering_rows = new byte[0];
		static byte[] commonByteArray_ORDER_ETL_Filtering_rows = new byte[0];
		...
		public Integer Years_in_Enterprise;

		public Integer getYears_in_Enterprise() {
			return this.Years_in_Enterprise;
		}
		...
		public Integer Sales_Values;

		public Integer getSales_Values() {
			return this.Sales_Values;
		}
		...
		public void copyDataTo(row2Struct other) {
			...
			other.ID = this.ID;
			other.Years_in_Enterprise = this.Years_in_Enterprise;
			other.First_Name = this.First_Name;
			other.Last_Name = this.Last_Name;
			other.Sales_Values = this.Sales_Values;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ORDER_ETL_Filtering_rows.length) {
					if (length < 1024
							&& commonByteArray_ORDER_ETL_Filtering_rows.length == 0) {
						commonByteArray_ORDER_ETL_Filtering_rows = new byte[1024];
					} else {
						commonByteArray_ORDER_ETL_Filtering_rows = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ORDER_ETL_Filtering_rows, 0,
						length);
				strReturn = new String(
						commonByteArray_ORDER_ETL_Filtering_rows, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ORDER_ETL_Filtering_rows) {
				...
				try {
					...
					this.Years_in_Enterprise = readInteger(dis);

					this.First_Name = readString(dis);

					this.Last_Name = readString(dis);

					this.Sales_Values = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.Years_in_Enterprise, dos);
				...
				writeInteger(this.Sales_Values, dos);
		...
		public String toString() {
			...
			sb.append(",Years_in_Enterprise="
					+ String.valueOf(Years_in_Enterprise));
			sb.append(",First_Name=" + First_Name);
			sb.append(",Last_Name=" + Last_Name);
			sb.append(",Sales_Values=" + String.valueOf(Sales_Values));
			sb.append("]");
	...
	public void tRowGenerator_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "ID",
						"Years_in_Enterprise", "First_Name", "Last_Name",
						"Sales_Values", });
				...
				String[] rangetSampleRow_1 = "1,5,9..12".split(",");
				...
				class tRowGenerator_1Randomizer {
					...
					public Integer getRandomYears_in_Enterprise() {

						return Numeric.random(0, 100);

					}

					public String getRandomFirst_Name() {

						return TalendDataGenerator.getFirstName();

					}

					public String getRandomLast_Name() {

						return TalendDataGenerator.getLastName();

					}

					public Integer getRandomSales_Values() {
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					...
					row1.Years_in_Enterprise = randtRowGenerator_1
							.getRandomYears_in_Enterprise();
					row1.First_Name = randtRowGenerator_1.getRandomFirst_Name();
					row1.Last_Name = randtRowGenerator_1.getRandomLast_Name();
					row1.Sales_Values = randtRowGenerator_1
							.getRandomSales_Values();
					...
					if (!rangeSettSampleRow_1.contains(nb_line_tSampleRow_1)) {
						...
						row2.Years_in_Enterprise = row1.Years_in_Enterprise;

						row2.First_Name = row1.First_Name;

						row2.Last_Name = row1.Last_Name;

						row2.Sales_Values = row1.Sales_Values;
					...
					if (row2 != null) {
						...
						if (row2.Years_in_Enterprise != null) { //
							row_tLogRow_1[1] = String
									.valueOf(row2.Years_in_Enterprise);
						...
						if (row2.Last_Name != null) { //
							row_tLogRow_1[3] = String.valueOf(row2.Last_Name);

						} //

						if (row2.Sales_Values != null) { //
							row_tLogRow_1[4] = String
									.valueOf(row2.Sales_Values);
	...
	public static void main(String[] args) {
		final Filtering_rows Filtering_rowsClass = new Filtering_rows();

		int exitCode = Filtering_rowsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Filtering_rows.class
					.getClassLoader().getResourceAsStream(
							"order_etl/filtering_rows_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Filtering_rows.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Filtering_rows");
		}
...
/************************************************************************************************
 * 94661 characters generated by Talend Open Studio for Data Integration on the
 * September 27, 2019 2:50:19 PM EDT
 ************************************************************************************************/
