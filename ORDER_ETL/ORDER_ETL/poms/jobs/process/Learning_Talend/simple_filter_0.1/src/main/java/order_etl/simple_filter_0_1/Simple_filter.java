...
package order_etl.simple_filter_0_1;
...
public class Simple_filter implements TalendJob {
	...
	private final String jobName = "Simple_filter";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Simple_filter.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Simple_filter.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_ORDER_ETL_Simple_filter = new byte[0];
		static byte[] commonByteArray_ORDER_ETL_Simple_filter = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ORDER_ETL_Simple_filter.length) {
					if (length < 1024
							&& commonByteArray_ORDER_ETL_Simple_filter.length == 0) {
						commonByteArray_ORDER_ETL_Simple_filter = new byte[1024];
					} else {
						commonByteArray_ORDER_ETL_Simple_filter = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ORDER_ETL_Simple_filter, 0,
						length);
				strReturn = new String(commonByteArray_ORDER_ETL_Simple_filter,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ORDER_ETL_Simple_filter) {
	...
	public void tFixedFlowInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.setTableName("accepted");
				util_tLogRow_1.addRow(new String[] { "LastName", "Gender",
						"Age", "City", });
				...
				util_tLogRow_2.setTableName("rejected");
				util_tLogRow_2.addRow(new String[] { "LastName", "Gender",
						"Age", "City", "errorMessage", });
				...
				result_tFixedFlowInput_1
						.append("VmFuIEJ1cmVuO007NzM7Q2hpY2FnbwpBZGFtcztNOzQwO0FsYmFueQpKZWZmZXJzb247Rjs2NjtO");
				result_tFixedFlowInput_1
						.append("ZXcgWW9yawpBZGFtcztNOzk7QWxiYW55CkplZmZlcnNvbjtNOzMwO0NoaWNhZ28KQ2FydGVyO0Y7");
				result_tFixedFlowInput_1
						.append("MjY7Q2hpY2FnbwpIYXJyaXNvbjtNOzQwO05ldyBZb3JrClJvb3NldmVsdDtGOzE1O0NoaWNhZ28K");
				result_tFixedFlowInput_1
						.append("TW9ucm9lO007ODtCb3N0b24KQXJ0aHVyO007MjA7QWxiYW55ClBpZXJjZTtNOzE4O05ldyBZb3Jr");
				result_tFixedFlowInput_1
						.append("ClF1aW5jeTtGOzgzO0FsYmFueQpNY0tpbmxleTtNOzcwO0Jvc3RvbgpDb29saWRnZTtNOzQ7Q2hp");
				result_tFixedFlowInput_1
						.append("Y2FnbwpNb25yb2U7TTs2MDtDaGljYWdv");
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					while (fid_tFixedFlowInput_1.nextRecord()) {
						...
						if (0 < fid_tFixedFlowInput_1
							...
							row1.LastName = (colContent == null || colContent
						...
						if (1 < fid_tFixedFlowInput_1
							...
							row1.Gender = (colContent == null || colContent
									.length() == 0) ? null : colContent;
						} else {
						...
						if (3 < fid_tFixedFlowInput_1
							...
							row1.City = (colContent == null || colContent
									.length() == 0) ? null : colContent;
						} else {
						...
						Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1(
								"&&");
						ope_tFilterRow_1.matches((row1.LastName == null ? false
								: row1.LastName.length() < 9),
								" LastName.length() < 9 failed");
						ope_tFilterRow_1.matches((row1.Gender == null ? false
								: row1.Gender.compareTo("M") == 0),
								"Gender.compareTo(\"M\") == 0 failed");
						ope_tFilterRow_1.matches(
								(row1.Age == null ? false : row1.Age
										.compareTo(ParserUtils
												.parseTo_Integer(String
														.valueOf(10))) > 0),
								"Age.compareTo(10) > 0 failed");
						...
						ope_tFilterRow_1.matches(
								(row1.Age == null ? false : row1.Age
										.compareTo(ParserUtils
												.parseTo_Integer(String
														.valueOf(80))) < 0),
								"Age.compareTo(80) < 0 failed");

						ope_tFilterRow_1.matches(
								(row1.City.equals("Chicago") || row1.City
										.equals("New York")),
						...
						if (row2 != null) {
							...
							if (row2.LastName != null) { //
								row_tLogRow_1[0] = String
										.valueOf(row2.LastName);

							} //

							if (row2.Gender != null) { //
								row_tLogRow_1[1] = String.valueOf(row2.Gender);
							...
							if (row2.City != null) { //
								row_tLogRow_1[3] = String.valueOf(row2.City);
						...
						if (row3 != null) {
							...
							if (row3.LastName != null) { //
								row_tLogRow_2[0] = String
										.valueOf(row3.LastName);

							} //

							if (row3.Gender != null) { //
								row_tLogRow_2[1] = String.valueOf(row3.Gender);
							...
							if (row3.City != null) { //
								row_tLogRow_2[3] = String.valueOf(row3.City);
	...
	public static void main(String[] args) {
		final Simple_filter Simple_filterClass = new Simple_filter();

		int exitCode = Simple_filterClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Simple_filter.class
					.getClassLoader().getResourceAsStream(
							"order_etl/simple_filter_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Simple_filter.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Simple_filter");
		}
...
/************************************************************************************************
 * 107612 characters generated by Talend Open Studio for Data Integration on the
 * September 27, 2019 2:18:00 PM EDT
 ************************************************************************************************/
